      ...
      <div className="page">
        ...
        <section className="hero">
          <div>
            ...
            <div className="ctaRow">
              <a href="#how" className="btnPrimary">How It Works</a>
              <Link href="/kfx" className="btnGhost">See KFX (Rewards)</Link>
            </div>
          </div>

          {/* Right visual (keeps index layout balance) */}
        ...
        <section className="section">
          ...
          <p className="sectionSub">
            The Ownership Token is a <strong>compliant security token</strong> representing fractional exposure to vending revenue.
            It’s separate from <Link href="/kfx" className="footLink">KFX (rewards)</Link> and will be offered via a licensed platform with KYC/AML.
          </p>

          <div className="gridCards">
            <div className="card"><h3 className="cardTitle">Real-World Revenue</h3><p className="cardText">Backed by sales from placed machines.</p></div>
            <div className="card"><h3 className="cardTitle">Reg-Friendly Rails</h3><p className="cardText">Offered under exemptions (e.g., Reg D/CF) via partners.</p></div>
            <div className="card"><h3 className="cardTitle">Transparency</h3><p className="cardText">Standardized reporting, on-chain access, clear terms.</p></div>
            <div className="card">
              <h3 className="cardTitle">Details</h3>
              <p className="cardText">📈 Underlying: Vending Revenue</p>
              <p className="cardText">🛡️ Offering: Reg-compliant (via partners)</p>
        ...
        <section id="how" className="section sectionDark">
          ...
          <p className="sectionSub">Clean steps from interest to ongoing ownership lifecycle.</p>

          <div className="gridCards">
            <div className="card"><h3 className="cardTitle">1) Early Access & Verification</h3><p className="cardText">Join the list, complete KYC/AML with the offering partner when live.</p></div>
            <div className="card"><h3 className="cardTitle">2) Allocation & Purchase</h3><p className="cardText">Receive allocation, review documents, complete purchase on partner portal.</p></div>
            <div className="card"><h3 className="cardTitle">3) Transparent Reporting</h3><p className="cardText">Track placement progress, sales summaries, and distributions via standardized updates.</p></div>
          </div>

          <div className="infoCard">
            <p className="infoText">
              <strong className="infoStrong">Note:</strong> This page is informational and not an offer to sell securities.
              Any offering will be made only through official documentation on a licensed platform.
            </p>
          </div>
        </section>
        ...
        <section className="section">
          ...
          <div className="gridCards">
            <div className="card"><h3 className="cardTitle">Real-World Yield Exposure</h3><p className="cardText">Potential distributions tied to actual sales at placed machines.</p></div>
            <div className="card"><h3 className="cardTitle">Aligned with Community</h3><p className="cardText">Ownership that grows with network scale, not just brand fandom.</p></div>
            <div className="card"><h3 className="cardTitle">On-Chain Access</h3><p className="cardText">Modern rails for access; future secondary liquidity subject to rules.</p></div>
          </div>
        </section>
        ...
        <section className="section sectionDark">
          ...
          <div style={{ textAlign: "center", marginTop: 24 }}>
            ...
            <p style={{ marginTop: 12 }}>
              Prefer perks? <Link href="/kfx" className="footLink">Explore KFX →</Link>
            </p>
          </div>
        </section>
        ...
        <section className="section">
          ...
          <p className="sectionSub">Get on the list to receive allocation details as soon as we go live.</p>
...
const FAQ_ITEMS = [
  { q: "Is this live now?", a: "Not yet. This page previews the compliant offering to come. Join Early Access to be notified first when allocations open." },
  { q: "How is this different from KFX?", a: "KFX is a utility/reward token for perks and access. The Ownership Token is a compliant security representing fractional exposure to vending revenue." },
  { q: "Will I need KYC/AML?", a: "Yes. Verification is required by the licensed offering platform prior to any purchase." },
  { q: "Where do distributions come from?", a: "From sales revenue of deployed machines in the relevant pool, net of fees and per the offering documents." },
  { q: "Can I sell my tokens later?", a: "Any potential transferability or secondary trading would be subject to regulations and platform rules; details at launch." },
];
