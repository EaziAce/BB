    ...
    <>
      ...
      <div className="page">
        ...
        <header className="header">
          ...
          <nav className="nav">
            <a href="#placement" className="navButton">Placement</a>
        ...
        <section className="hero">
          <div className="heroLeft">
            ...
            <p className="microTrust">
              No-cost install for qualified locations. Fast setup. Fully managed.
            </p>
        ...
        <section id="how" className="section sectionDark">
          ...
          <div style={{ textAlign: "center", marginTop: 20 }}>
            <Link href="/contact" className="btnPrimary">Get placement options</Link>
          </div>
        </section>
        ...
        {/* placement options */}
        <section id="placement" className="section sectionDark">
        ...
        <footer className="footer">
          <div>
            <a href="#placement" className="footLink">Placement</a>
      ...
      <style jsx>{`
        ...
        .hero { display: grid; grid-template-columns: 1.2fr 1fr; gap: 28px; padding: 48px 0; align-items: center; }
        ...
        .microTrust { margin-top: 10px; font-size: 13px; color: #d4d4d8; }
        ...
        .gridCards { display: grid; gap: 24px; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); max-width:1100px; margin:0 auto; text-align:center; }

        .card { border: 1px solid #27272a; padding: 20px; border-radius: 16px; background: rgba(24,24,27,.4); }
        ...
        .footLink { color: #00b8ff; font-weight: 800; text-decoration: none; }
